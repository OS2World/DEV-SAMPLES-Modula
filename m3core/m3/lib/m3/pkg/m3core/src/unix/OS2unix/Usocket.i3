...
(*                                                             *)
(* Last modified on Sat Dec 07 15:16:48 PDT 1996 by preschern  *)
 ...
 *)
  ...
  SO_L_BROADCAST  = 16_0200;         (* limited broadcast sent on all IFs *)
  SO_RCV_SHUTDOWN = 16_0400;         (* set if shut down called for rcv *)
  SO_SND_SHUTDOWN = 16_0800;         (* set if shutdown called for send *)
 ...
 *)
  ...
  SO_OPTIONS      = 16_1010;         (* get socket options *)
